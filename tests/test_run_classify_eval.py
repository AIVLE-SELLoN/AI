...
class TestFewShotLeakFilter:
    ...
    def test_parse_few_shot_examples_finds_all_v5_inputs(self):
        ...
        40 → 44: v5 3차 수정(2026-08-09)에서 감성 정책 예시 4개 추가
        (22-1 칭찬 대비, 22-2 가정형, 22-3 포장결함 관측, 24-1 담백한 오배송 서술).
        44 → 46: 같은 날 손검토 확정 반영 — 배송 미도착 예시 2개 추가
        (20-6 미도착 주장 → -1, 20-7 일정만 문의 → 0).
        """
